...
- **CSV completo:** serviços meteorológicos gratuitos não fornecem, por si, os IDs/grade/meses oficiais nem a previsão treinada exigida. O backend deriva a quantidade de linhas do CSV oficial de teste, compara todos os IDs na mesma ordem e não libera o arquivo sem manifesto de modelo retreinado, artefato reproduzível e validação científica/temporal aprovada.
